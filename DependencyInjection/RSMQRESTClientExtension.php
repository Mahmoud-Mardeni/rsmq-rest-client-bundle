...
namespace Redis\RSMQRESTClientBundle\DependencyInjection;
 ...
 */
class RSMQRESTClientExtension extends Extension implements PrependExtensionInterface
{
    /**
     * {@inheritdoc}
     */
    public function load(array $configs, ContainerBuilder $container)
    {
        ...
        $container->setParameter('rsmq_rest_config', $config);
